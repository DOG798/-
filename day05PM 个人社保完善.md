...
<html>
	<head>
		...
		<script>
			function calc(){
				sal=document.getElementById("qq").value;
				salnum=parseInt(sal);//
				ylgr=salnum*0.08;
				ylgs=salnum*0.2;
				...
				shgs=salnum*0.008;
				document.getElementById("shgs").innerText=shgs;
				gjjgr=salnum*0.12;
				document.getElementById("gjjgr").innerText=gjjgr;
				gjjgs=salnum*0.12;
				document.getElementById("gjjgs").innerText=gjjgs;
				grhj=ylgr+ybgr+sygr+gjjgr;
				gshj=ylgs+ybgs+sygs+gsgs+sygs+gjjgs;
				document.getElementById("grhj").innerText=grhj;
				document.getElementById("gshj").innerText=gshj;
				ze=grhj+gshj;
				document.getElementById("ze").innerText=ze;
			}
		</script>
	</head>
	<body>
		<div class="container text-center">
			<h2>个人社保计算软件-中北大学-吕洪泽</h2>
			<table class="table table-bordered text-center table-hover">
				<tr>
					<td>工资</td>
					<td colspan="3">
						<input class="form-control" type="text" id="qq" placeholder="请输入你的工资"/>
					</td>
					<td>
